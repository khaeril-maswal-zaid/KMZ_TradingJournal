...
type Props = {
    ...
    rowErrors: Map<string, Partial<Record<TransactionImportField, string>>>;
...
export function EditableTransactionTable({
    ...
    const isEmpty = rows.every(isImportRowEmpty);
                ...
                <Table className="min-w-[1180px]">
                    <TableHeader className="sticky top-0 z-10 bg-muted/95 backdrop-blur">
                        <TableRow className="hover:bg-muted/95">
                            ...
                            {transactionImportColumns.map((column) => (
                                <TableHead
                                    key={column.key}
                                    className={cn(
                                        column.width,
